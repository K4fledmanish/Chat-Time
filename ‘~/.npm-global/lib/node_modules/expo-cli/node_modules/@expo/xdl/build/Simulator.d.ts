...
export declare function doesExpoClientNeedUpdatedAsync(simulator: Pick<SimControl.Device, 'udid'>, sdkVersion?: string): Promise<boolean>;
...
export declare function openUrlInSimulatorSafeAsync({ url, udid, isDetached, sdkVersion, }: {
    url: string;
    udid?: string;
    sdkVersion?: string;
    isDetached: boolean;
