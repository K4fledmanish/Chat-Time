...
async function configureIOSStepAsync(props) {
  const applyingIOSConfigStep = CreateApp().logNewSection('iOS config syncing');
  await (0, _configureIOSProjectAsync().default)(props);
...
async function configureAndroidStepAsync(props) {
  ...
  await (0, _configureAndroidProjectAsync().default)(props);
...
async function warnIfDependenciesRequireAdditionalSetupAsync(pkg, sdkVersion) {
