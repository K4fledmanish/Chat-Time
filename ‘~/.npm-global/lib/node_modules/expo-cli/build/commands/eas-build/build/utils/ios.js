...
async function _getBundleIdentifier(projectDir, manifest) {
  const bundleIdentifierFromPbxproj = _configPlugins().IOSConfig.BundleIdenitifer.getBundleIdentifierFromPbxproj(projectDir);

  const bundleIdentifierFromConfig = _configPlugins().IOSConfig.BundleIdenitifer.getBundleIdentifier(manifest);
